...
// Deliberately not from pdf-geometry.js: that imports pdf-lib, and this module is reached
// from the document session, so doing so would put 425 KB in front of the first paint.
