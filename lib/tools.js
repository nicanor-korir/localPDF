...
export const TOOLS = [
  {
    ...
    seoTitle: 'Merge PDF files locally',
    seoDescription: 'Combine PDFs and images into one document, in your browser. No uploads, no account, no watermark. Your files never leave your device.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Organise PDF pages',
    seoDescription: 'Reorder, rotate, crop and delete pages, or insert a blank one. Runs entirely in your browser, so nothing is uploaded.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Extract pages from a PDF',
    seoDescription: 'Pick the pages you want and save them as a new PDF. Runs entirely in your browser, so your file never leaves your device.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Split a PDF into separate files',
    seoDescription: 'Break one PDF into several, by range, every N pages, or one file per page, downloaded as a zip. Nothing is uploaded.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Unlock a PDF: remove passwords and restrictions',
    seoDescription: 'Remove a password you know, or restrictions on printing and copying that need no password at all. Done on your device, not on a server.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Password protect a PDF with AES-256',
    seoDescription: 'Add a password and restrict printing, copying or editing. The encryption happens in your browser, so the file is never uploaded.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Compress a PDF',
    seoDescription: 'Make a PDF smaller by re-encoding its images. Never returns a bigger file, and never uploads yours.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Convert a PDF to images, text, Markdown or Word',
    seoDescription: 'Turn a PDF into PNG or JPEG pages, plain text, Markdown or a Word document, all in your browser.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Edit a PDF: add text and images',
    seoDescription: 'Add text and pictures on top of a page and drag them into place. Runs on your device; nothing is uploaded.',
    status: 'ready',
  ...
  },
  {
    ...
    seoTitle: 'Redact a PDF properly',
    seoDescription: 'Remove content for good rather than covering it with a black box, and the result is checked before it downloads.',
    status: 'ready',
