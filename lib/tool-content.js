 ...
 *
 * Kept here rather than in the page so the visible answers and the FAQPage structured data
 * are literally the same strings. Marking up an answer a visitor cannot see is the thing
 * search engines penalise, and it would also mean the two could drift.
 */
export const HOME_FAQ = [
  {
    question: 'Is this really free?',
    answer:
      'Yes. No paid tier, no trial, no watermark. It costs us almost nothing to run because your computer does all the work.',
  },
  {
    question: 'How big a file can I use?',
    answer:
      'As big as your computer can hold. There is no server deciding you have hit a limit, so the only ceiling is your own memory.',
  },
  {
    question: 'Do I need to install anything?',
    answer:
      'No. It runs in the browser you already have. If you want it in your dock or on your home screen, your browser can install it from its own menu.',
  },
  {
    question: 'Can I use it on confidential documents?',
    answer:
      'That is exactly what it is for. Nothing is uploaded, so a contract or a payslip never leaves your machine. The Private badge on every tool shows you the rule your browser is following.',
  },
  {
    question: 'What happens when I close the tab?',
    answer:
      'Everything goes. Your work lives in the page while it is open and nowhere else, so keep the finished file once you have saved it. The original on your disk is never touched.',
  },
  {
    question: 'Does it work without internet?',
    answer:
      'Yes, once the page has loaded once. Your browser keeps a copy, so you can come back to it on a plane or on a machine that is kept offline on purpose.',
  },
];
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          ...
          'page, because copying a page without its document’s form definition would otherwise leave ' +
  ...
  organise: {
    ...
    faq: [
      NEVER_UPLOADED,
      {
        ...
        answer:
          'Yes, with the Undo button or Ctrl/Cmd + Z. Every page edit can be walked back, including ' +
          'deletions.',
      },
      {
  ...
  extract: {
    ...
    faq: [
      NEVER_UPLOADED,
      {
        ...
        answer:
          'Yes. Typing "3, 1" extracts page 3 first, because someone writing them in that order meant ' +
    ...
    faq: [
      {
        ...
        answer:
          'The document cannot be opened by us or by anyone else. There is no recovery and no ' +
    ...
    faq: [
      {
        ...
        answer:
          ...
          'instead. The page tells you when it finds nothing to extract rather than handing ' +
          'you a blank file.',
      },
      {
